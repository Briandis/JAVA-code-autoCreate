...
def __create_method(config: dict):
    ...
    if "oneToOne" in config:
        ...
        for obj in config["oneToOne"]:
            ...
            method_str += f'{tag}public List<{config["className"]}> find{config["className"]}OneToOne{obj["className"]}{manny_table}({select_low_param_class_name}{config["className"]} {stringUtil.low_str_first(config["className"])}{key_word_str}, @Param("{stringUtil.low_str_first(obj["className"])}") {obj["className"]} {stringUtil.low_str_first(obj["className"])}{temp_key_word}, @Param("page") Page page{temp_sql});\n\n'
            method_str += f'{tag}public Integer countFind{config["className"]}OneToOne{obj["className"]}{manny_table}({select_low_param_class_name}{config["className"]} {stringUtil.low_str_first(config["className"])}{key_word_str}, @Param("{stringUtil.low_str_first(obj["className"])}") {obj["className"]} {stringUtil.low_str_first(obj["className"])}{temp_key_word});\n\n'
            method_str += f'{tag}public List<{obj["className"]}> linkOne{obj["className"]}{manny_table}({select_low_param_class_name}{config["className"]} {stringUtil.low_str_first(config["className"])}{key_word_str}, @Param("{stringUtil.low_str_first(obj["className"])}") {obj["className"]} {stringUtil.low_str_first(obj["className"])}{temp_key_word}, @Param("page") Page page{temp_sql});\n\n'
    ...
    if "oneToMany" in config:
        ...
        for obj in config["oneToMany"]:
            ...
            if obj["className"] in obj_table:
                manny_table = f'On{stringUtil.upper_str_first(obj["key"]["attr"])}'
            method_str += f'{tag}public List<{config["className"]}> find{config["className"]}OneToMany{obj["className"]}{manny_table}({select_low_param_class_name}{config["className"]} {stringUtil.low_str_first(config["className"])}{key_word_str}, @Param("{stringUtil.low_str_first(obj["className"])}") {obj["className"]} {stringUtil.low_str_first(obj["className"])}{temp_key_word}, @Param("page") Page page, @Param("page1") Page page1{temp_sql});\n\n'
            method_str += f'{tag}public Integer countFind{config["className"]}OneToMany{obj["className"]}{manny_table}({select_low_param_class_name}{config["className"]} {stringUtil.low_str_first(config["className"])}{key_word_str}, @Param("{stringUtil.low_str_first(obj["className"])}") {obj["className"]} {stringUtil.low_str_first(obj["className"])}{temp_key_word}, @Param("page") Page page, @Param("page1") Page page1);\n\n'
            method_str += f'{tag}public List<{obj["className"]}> linkMany{obj["className"]}{manny_table}({select_low_param_class_name}{config["className"]} {stringUtil.low_str_first(config["className"])}{key_word_str}, @Param("{stringUtil.low_str_first(obj["className"])}") {obj["className"]} {stringUtil.low_str_first(obj["className"])}{temp_key_word}, @Param("page") Page page, @Param("page1") Page page1{temp_sql});\n\n'
            obj_table.add(obj["className"])
            import_set.add(f'import {obj["path_pojo"]}.{obj["className"]};\n')
    ...
    if "oneToOne" in config:
        ...
        for obj in config["oneToOne"]:
            ...
            if obj["className"] in obj_table:
                manny_table = f'On{stringUtil.upper_str_first(obj["key"]["attr"])}'
            method_str += f'{tag}public List<{config["className"]}> query{config["className"]}OneToOne{obj["className"]}{manny_table}({select_low_param_class_name}{config["className"]} {stringUtil.low_str_first(config["className"])}{key_word_str}, @Param("{stringUtil.low_str_first(obj["className"])}") {obj["className"]} {stringUtil.low_str_first(obj["className"])}{temp_key_word}, @Param("page") Page page{temp_sql});\n\n'
            obj_table.add(obj["className"])
            # 左外连无需计数，总次数为左表
    ...
    if "oneToMany" in config:
        ...
        for obj in config["oneToMany"]:
            ...
            if obj["className"] in obj_table:
                manny_table = f'On{stringUtil.upper_str_first(obj["key"]["attr"])}'
            method_str += f'{tag}public List<{config["className"]}> query{config["className"]}OneToMany{obj["className"]}{manny_table}({select_low_param_class_name}{config["className"]} {stringUtil.low_str_first(config["className"])}{key_word_str}, @Param("{stringUtil.low_str_first(obj["className"])}") {obj["className"]} {stringUtil.low_str_first(obj["className"])}{temp_key_word}, @Param("page") Page page, @Param("page1") Page page1{temp_sql});\n\n'
            obj_table.add(obj["className"])
            # 左外连无需计数
            # 左外联最终条数有左表决定
    ...
    if "manyToMany" in config:
        ...
        for obj in config["manyToMany"]:
            ...
            method_str += f'{tag}public List<{config["className"]}> find{config["className"]}ManyToManyLink{obj["to"]["className"]}On{obj["many"]["className"]}{manny_table}({select_low_param_class_name}{config["className"]} {stringUtil.low_str_first(config["className"])}{key_word_str}, @Param("page") Page page{temp_sql});\n\n'
    ...
    if "manyToMany" in config:
        ...
        for obj in config["manyToMany"]:
            ...
            if f'{obj["to"]["className"]}On{obj["many"]["className"]}' in obj_table:
                manny_table = f'Join{stringUtil.underscore_to_big_hump(obj["to"]["foreign_key"])}'
            obj_table.add(f'{obj["to"]["className"]}On{obj["many"]["className"]}')
            method_str += f'{tag}public List<{config["className"]}> query{config["className"]}ManyToManyLink{obj["to"]["className"]}On{obj["many"]["className"]}{manny_table}({select_low_param_class_name}{config["className"]} {stringUtil.low_str_first(config["className"])}{key_word_str}, @Param("page") Page page{temp_sql});\n\n'
